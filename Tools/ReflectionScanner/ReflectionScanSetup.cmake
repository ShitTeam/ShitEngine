    ...
    if(CMAKE_CXX_COMPILER)
        execute_process(
            COMMAND ${CMAKE_COMMAND} -P
                "${CMAKE_SOURCE_DIR}/Tools/ReflectionScanner/detect_system_includes.cmake"
...
# CMake 配置期从 LIBCLANG_PREFIX 自动推导，通过 --resource-dir 传入，
# 避免 Scanner.cpp 硬编码版本号（LLVM 升级或换机器后不再失效）。
if(NOT DEFINED _REFLECT_CLANG_RESOURCE_DIR)
    set(_REFLECT_CLANG_RESOURCE_DIR "")
    if(EXISTS "${LIBCLANG_PREFIX}/lib/clang")
...
function(setup_reflection_scan SCOPE_NAME INPUT_DIR OUTPUT_DIR INCLUDE_ROOT)
    ...
    add_custom_command(
        ...
        DEPENDS ReflectionScanner ${REFLECTION_HEADERS}
    )
