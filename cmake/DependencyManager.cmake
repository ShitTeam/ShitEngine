...
macro(find_or_fetch_dependency DEP_NAME PACKAGE_NAME GIT_REPO GIT_TAG LOCAL_PATH LINK_TYPE)
    ...
    if(${PACKAGE_NAME}_FOUND OR ${DEP_NAME}_FOUND)
        ...
        # SDL3_mixer
        if("${DEP_NAME}" STREQUAL "SDL3_mixer")
            set(SDLMIXER_VENDORED ON CACHE BOOL "" FORCE)    # 使用内置解码
            set(SDLMIXER_VORBIS_STB ON CACHE BOOL "" FORCE) # 开启内置 OGG 支持
        endif()

        # SDL3_ttf
        if("${DEP_NAME}" STREQUAL "SDL3_ttf")
